...
#define Distance_Threshold__Next_Node_For_Approaching 7 // 距离阈值，判定是否已到达目标点
#define RemainDistance_Threshold__Charge 10000          // 剩余里程阈值，判定是否需要充电
